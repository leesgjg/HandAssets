...
public class ScannerEvent_Test : MonoBehaviour
{
    int lang;
    ...
    public TMP_Text result_message; // Screen1 > Result
    ...
    void OnCollisionEnter(Collision collision){
        ...
        if ( !o_item_name.Equals("Untagged") && current_canvas.Equals("screen1")){
            ...
            if(!cancel_yn.Equals("Y")){ 
                ...
                if(!"Y".Equals(discount_auth_yn) && !dupcheck_scanned_list.ContainsKey(o_item_code)){
                    ...
                    // Todo
                    Debug.Log("[Todo] discount_auth_yn이 Y가 아닐 때도 허용해야하는가");
                }
            ...
            // ----------------------------------
                ...
                if (scanned_list.ContainsKey(o_item_name) && !canceled_list.ContainsKey(o_item_code)){
                    ...
                    M_EventLogger.EventLogging(GlobalEnv.ACTOR_SYSTEM, GlobalEnv.EVENT_CATE_SYS_MSG, GlobalEnv.EVENT_TYPE_SCAN_REMOVE, o_item_name, "msg:"+GlobalEnv.del_msg);
