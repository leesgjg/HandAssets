...
namespace Valve.VR.InteractionSystem
{
	...
	public class Screen1Event : MonoBehaviour
    {
        ...
        protected virtual void OnHandHoverEnd( Hand hand ){
            ...
            // ----------------------------------
                ...
                if (item_counting > 0) {
                    ...
                    M_EventLogger.EventLogging(GlobalEnv.ACTOR_SYSTEM, GlobalEnv.EVENT_CATE_ACT, GlobalEnv.EVENT_TYPE_RESULT_MSG, "Screen1:btn_pay()", "msg:" + LangText.alert_tryingToPay[lang] + "|^|msg_type:결제 시도");
                } else {
                    result_message.text = LangText.screen1_noitem[lang];
                    result_message.color = Color.red;
                    result_background.color = Color.white;
        ...
        **/
        private void ChangeCanvas1toCanvas2After1s()
        {
            ...
            M_EventLogger.EventLogging(GlobalEnv.ACTOR_SYSTEM, GlobalEnv.EVENT_CATE_SCREEN, GlobalEnv.EVENT_TYPE_CHANGE, "ChangeCanvas1toCanvas2After1s()", "Screen1 to Screen2, discount_yn:"+ discount_yn);
        }
	...
	public class Screen1Editor : UnityEditor.Editor
	{
		//-------------------------------------------------
